...
main = tkinter.Tk()
main.title("Ensemble Insights: Revolutionizing Bug Prediction in Software Development") #designing main screen
...
def runSVM():
    ...
    calculateMetrics("SVM Classifier", y_test, predict)
...
def runRF():
    ...
    calculateMetrics("RFC Model", y_test, predict)
...
def runVC():
    ...
    calculateMetrics("Ensemble Voting Classifier", y_test, predict)
...
def runXGBoost():
    ...
    calculateMetrics("XGBoost Model", y_test, predict)
...
font = ('times', 16, 'bold')
title = Label(main, text='Ensemble Insights: Revolutionizing Bug Prediction in Software Development', justify=LEFT)
title.config(bg='sky blue', fg='DarkOrchid1')  
...
vcButton = Button(main, text="Run Ensemble Voting Classifier", command=runVC)
vcButton.place(x=580,y=150)
vcButton.config(font=font1)

extensionButton = Button(main, text="Build & Train XGBoost Model", command=runXGBoost)
